                ...
                try:
                    if cl.getGroup(op.param1).preventedJoinByTicket == False:
                        if op.param2 not in Bots and op.param2 not in owner and op.param2 not in admin and op.param2 not in staff:
                            ...
                            kj.sendMessage(op.param1,"wah mainan qr, minta di cipok")
        ...
        if op.type == 19:
                                ...
                                try:
                                    ...
                                    try:
                                        ...
                                        try:
                                            ...
                                            Ticket = kk.reissueGroupTicket(op.param1)
                                            wait["blacklist"][op.param2] = True
                                            random.choice(ABC).sendMessage(op.param1,"Masuk bro")
                                        except:
                                            pass
                return
            ...
            if Amid in op.param3:
                ...
                if op.param2 in staff:
                    ...
                    try:
                        kk.kickoutFromGroup(op.param1,[op.param2])
                        kk.inviteIntoGroup(op.param1,[mid,Amid,Jmid,Zmid])
                        random.choice(ABC).cancelGroupInvitation(op.param1,[op.param3])
                        ki.acceptGroupInvitation(op.param1)
                        ki.sendMessage(op.param1,"m")
                    except:
                        try:
                            cl.kickoutFromGroup(op.param1,[op.param2])
                            cl.inviteIntoGroup(op.param1,[Bmid,Amid,Jmid,Zmid])
                            random.choice(ABC).cancelGroupInvitation(op.param1,[op.param3])
                            ki.acceptGroupInvitation(op.param1)
                            ki.sendMessage(op.param1,"m")
                        except:
                            try:
                                kj.kickoutFromGroup(op.param1,[op.param2])
                                kj.inviteIntoGroup(op.param1,[mid,Amid,Bmid,Zmid])
                                random.choice(ABC).cancelGroupInvitation(op.param1,[op.param3])
                                ki.acceptGroupInvitation(op.param1)
                                ki.sendMessage(op.param1,"m")
                            except:
                                try:
                                    sw.kickoutFromGroup(op.param1,[op.param2])
                                    sw.inviteIntoGroup(op.param1,[mid,Amid,Jmid,Bmid])
                                    random.choice(ABC).cancelGroupInvitation(op.param1,[op.param3])
                                    ki.acceptGroupInvitation(op.param1)
                                    ki.sendMessage(op.param1,"m")
                                except:
            ...
            if Bmid in op.param3:
                ...
                if op.param2 in staff:
                    ...
                    try:
                        ki.kickoutFromGroup(op.param1,[op.param2])
                        ki.inviteIntoGroup(op.param1,[mid,Bmid,Jmid,Zmid])
                        random.choice(ABC).cancelGroupInvitation(op.param1,[op.param3])
                        kk.acceptGroupInvitation(op.param1)
                        kk.sendMessage(op.param1,"m")
                    except:
                                ...
                                try:
                                    ...
                                    try:
                                        ...
                                        try:
                                            ...
                                            try:
                                                cl.kickoutFromGroup(op.param1,[op.param2])
                                                cl.inviteIntoGroup(op.param1,[Amid,Bmid,Jmid,Zmid])
                                                random.choice(ABC).cancelGroupInvitation(op.param1,[op.param3])
                                                kk.acceptGroupInvitation(op.param1)
                                                kk.sendMessage(op.param1,"m")
                                            except:
                ...
                if op.param2 in staff:
                    ...
                    try:
                        ...
                        try:
                            ...
                            try:
                                sw.inviteIntoGroup(op.param1,[mid,Amid,Bmid,Jmid])
                                sw.kickoutFromGroup(op.param1,[op.param2])
                                kj.acceptGroupInvitation(op.param1)
                                kj.sendMessage(op.param1,"m")
                                ...
                                try:
                                    ...
                                    try:
                                        ...
                                        try:
                                            ...
                                            Ticket = kk.reissueGroupTicket(op.param1)
                                            wait["blacklist"][op.param2] = True
                                            random.choice(ABC).sendMessage(op.param1,"m")
                                        except:
                                            try:
                                                ki.kickoutFromGroup(op.param1,[op.param2])
                                                ki.inviteIntoGroup(op.param1,[op.param3])
...
#=========== [ Add Sticker ] ============#                                            
                          ...
                          if msg._from in admin:
                             ...
                             cl.sendMessage(msg)         
                             cl.sendMessage(msg.to,"Pm ja ya..")
